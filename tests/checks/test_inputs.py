...
class TestGatherInputsGovernancePack:
    ...
    def test_gather_governance_pack(self) -> None:
        """Test gathering governance pack content."""
        epic = _make_epic(
        ...
        assert "test-project" in result[0].source
        assert "placeholder" in result[0].content.lower()

    def test_governance_pack_requires_governance_config(self) -> None:
        """Test that governance_pack requires governance config."""
